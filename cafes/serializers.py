...
from .models import Cafe, Barrio, Reviewer, Review, Dish, Tag
...
class CafeSerializer(serializers.ModelSerializer):
    ...
    barrio_name = serializers.SlugRelatedField(queryset=Barrio.objects.all(),
                                               slug_field='name',
                                               source='barrio',
                                               write_only=True)
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'barrio', 'address', 'has_good_medialunas', 'notes',
                    'recommendation_count', 'tag', 'reviews','review_count', 'tagline','dishes','barrio_name','tag_names']
